      ...
      <div className="mt-4 grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-4">
        ...
        <div className="space-y-4">
          <NoteBlock title="about_me.txt">
            ...
            i like trying new things and i frequently push myself into situations that i am unfamiliar with. this has led me to fall in love with many things, i like climbing, i like photography, i like hiking biking, i like basketball, i like to go to the gym, and i like meeting new people. i also love eating food.
