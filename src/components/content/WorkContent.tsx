    ...
    () => [
      {
        ...
        period: "2025 - now",
        description:
          "leading subteam of firmware engineers to design and develop firmware for custom stm32 pcbs. leading various firmware projects. working along side several other subsystems to design the best car for michigan FSAE compitition. won 6th place last year out of 120 teams, hoping to do better this year we have alot in the works.",
        achievements: [
